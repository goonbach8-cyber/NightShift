...
func run() -> void:
	...
	for target in [Vector2(0,0), Vector2(-4.8,0), Vector2(-4.8,-2.3), Vector2(-4.8,0), Vector2(4.8,0), Vector2(4.8,-2.3), Vector2(4.8,0), Vector2(3.0,0), Vector2(3.0,3.6), Vector2(4.6,3.6), Vector2(0,3.6), Vector2(-4.8,3.6)]:
		var reached := false
		for frame in 240:
