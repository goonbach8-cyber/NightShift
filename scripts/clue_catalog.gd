...
const ENTRIES = {
	...
	&"missing": {"title":"Missing resident returns","lines":["A resident reported missing on Tuesday returned to work on Wednesday.","He says he never left and remembers speaking to his neighbours that evening."]},
